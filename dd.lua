    ...
    function WinTypes:CreateTab(name, players)
        ...
        function TabTypes:CreateGroupbox(name, side)
            ...
            function GroupTypes:CreateDropdown(name, options, callback)
                ...
                Tween = TweenService:Create(Object, tweenInfo, {Rotation = 180})
                Tween2 = TweenService:Create(Object, tweenInfo, {Rotation = 0}) 
                ...
                main_2.MouseButton1Click:Connect(function()
                    ...
                    if toggle_tween then
                        Tween:Play()
                    end
                    if toggle_tween == false then
                        Tween2:Play()
                    end
            ...
            function GroupTypes:CreateDropdown_2(name, options, callback)
                ...
                ImageLabel2.Parent = combobox
                ImageLabel2.BackgroundColor3 = Color3.fromRGB(57, 57, 57)
                ImageLabel2.BorderColor3 = Color3.fromRGB(21, 21, 21)
                ImageLabel2.BackgroundTransparency = 1
                ImageLabel2.Position = UDim2.new(0, 127, 0, -7)
                ImageLabel2.Size = UDim2.new(0, 28, 0, 28)
                ImageLabel2.Image = "rbxasset://textures/ui/Untitled-4 (2).png"
                ImageLabel2.ImageColor3 = Color3.fromRGB(255, 255, 255)


                local TweenService = game:GetService("TweenService")
                --local Object = combobox:WaitForChild("ImageLabel2") 
                ...
                --Tween3 = TweenService:Create(Object, tweenInfo, {Rotation = 180})
                --Tween4 = TweenService:Create(Object, tweenInfo, {Rotation = 0})
                ...
                main_2.MouseButton1Click:Connect(function()
                    title_15.ZIndex = 9
                    list.Visible = not list.Visible
                    toggle_tween2 = not toggle_tween2

                    if toggle_tween2 then
                        Tween3:Play()
                    end
                    if toggle_tween2 == false then
                        Tween4:Play()
                    end
