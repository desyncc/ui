    ...
    function WinTypes:CreateTab(name, players)
        ...
        function TabTypes:CreateGroupbox(name, side)
            ...
            function GroupTypes:CreateSlider2(name, min, max, def, text, Y,callback)
                ...
                UIGradient_16.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(181, 181, 181)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(120, 120, 120))}
                UIGradient_16.Rotation = 90
                UIGradient_16.Parent = bar
